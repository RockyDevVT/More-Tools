...
public class BlockTraciaLog extends ElementsMoreTools.ModElement {
	@GameRegistry.ObjectHolder("more_tools:tracialog")
	public static final Block block = null;
	public BlockTraciaLog(ElementsMoreTools instance) {
		super(instance, 46);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("tracialog"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("more_tools:tracialog", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("tracialog");
